...
describe('SchoolCardComponent', () => {
  ...
  beforeEach(async () => {
    ...
    fixture.componentRef.setInput('showOccupationRate', false);
    fixture.componentRef.setInput('occupationRate', '');
  ...
  it('should display school name', () => {
    const schoolNameEl = fixture.debugElement.query(By.css('.school-name')).nativeElement;
    expect(schoolNameEl.textContent).toContain('Colegiul Național A');
  });

  it('should display specialization', () => {
    const specializationEl = fixture.debugElement.query(By.css('.mb-2 span')).nativeElement;
    expect(specializationEl.textContent).toContain('Matematică-Informatică');
  });

  it('should display language', () => {
    const languageEl = fixture.debugElement.queryAll(By.css('.mb-2'))[1].nativeElement;
    expect(languageEl.textContent).toContain('Română');
  });

  it('should display first candidate info', () => {
    const firstCandidateEl = fixture.debugElement.queryAll(By.css('.mb-2'))[2].nativeElement;
    expect(firstCandidateEl.textContent).toContain('9.12');
    expect(firstCandidateEl.textContent).toContain('poziția 1');
  });

  it('should display last candidate info', () => {
    const lastCandidateEl = fixture.debugElement.queryAll(By.css('.mb-2'))[3].nativeElement;
    expect(lastCandidateEl.textContent).toContain('7.44');
    expect(lastCandidateEl.textContent).toContain('poziția 30');
  });

  it('should display position range', () => {
    const positionRangeEl = fixture.debugElement.queryAll(By.css('.mb-2'))[4].nativeElement;
    expect(positionRangeEl.textContent).toContain('1-30');
  });

  it('should not display occupancy rate by default', () => {
    const occupancyEl = fixture.debugElement.query(By.css('.occupancy'));
    expect(occupancyEl).toBeNull();
  });

  it('should display occupancy rate when showOccupationRate input is true', () => {
    fixture.componentRef.setInput('showOccupationRate', true);
    fixture.componentRef.setInput('occupationRate', '75');
    fixture.detectChanges();

    const occupancyEl = fixture.debugElement.query(By.css('.occupancy')).nativeElement;
    expect(occupancyEl.textContent).toContain('75%');
  });

  describe('formatGrade method', () => {
    it('should format numeric grade to 2 decimals', () => {
